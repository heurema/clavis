...
// Source: https://github.com/templui/templui/blob/75ff269e4b13e65e2ebc973835dea91e1112cca1/components/button/button.templ
// Local changes: utility import path. No component scripts are required.
import (
	"github.com/heurema/clavis/internal/web/ui/utils"
	"strings"
)
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.Href != "" && !p.Disabled {
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/button/button.templ`, Line: 62, Col: 13}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/button/button.templ`, Line: 64, Col: 31}
			}
			...
			if p.Target != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/button/button.templ`, Line: 66, Col: 21}
				}
			...
			if p.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/button/button.templ`, Line: 88, Col: 13}
				}
			...
			if p.Type != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/button/button.templ`, Line: 104, Col: 25}
				}
			...
			if p.Form != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/button/button.templ`, Line: 107, Col: 17}
				}
