...
The MVP needs screens for sign-in and initial access setup, plus read-only administrative views of users, connections and permissions. The browser does not offer management forms in the MVP; every mutation goes through the CLI.
