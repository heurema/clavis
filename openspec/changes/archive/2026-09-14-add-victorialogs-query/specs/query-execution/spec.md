...
- **THEN** the request fails with `SOURCE_ERROR`, `errorType: "response_too_large"` and a hint to narrow the request or raise the byte cap, and nothing is presented as data
