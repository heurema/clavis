...
- **THEN** the response keeps the first 1,000 complete rows in arrival order, reading stopped and the connection was closed, `truncated` is true, the hint names `limit` and a sort pipe, and the CLI exits 0
