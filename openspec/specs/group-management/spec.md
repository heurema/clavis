...
Let administrators describe access by team: groups with members that inherit the connections granted to the group, managed with the same conventions as users, connections and grants, with a read-only Groups page in the console.
